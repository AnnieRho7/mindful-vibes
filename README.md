...
### Color Palette
The chosen color scheme reflects a calming and mindful vibe, aligning with the project's theme. Here's a breakdown of the main colors used throughout the site:

| **Color**           | **Hex Code** | **Usage**                                           |
|---------------------|--------------|-----------------------------------------------------|
| **Primary Color**    | `#4CAF50`    | Used for buttons, links, and other key elements      |
| **Secondary Color**  | `#8BC34A`    | Accent color for hover effects and highlights        |
| **Background Color** | `#F5F5F5`    | Main background for the site                         |
| **Text Color**       | `#212121`    | Primary text color for readability                   |
